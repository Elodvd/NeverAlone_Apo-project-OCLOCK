...
INSERT INTO "event" ("id", "title", "description", "date_hour", "capacity", "price", "adress","category", "user_id" ) VALUES
(1,'Match de foot à la télé', 'Soiree match Lille/PSG et apéro dans un bar à Paris XVII (lieu à définir ensemble)', '2022-02-26 18:50:00', '10', 'GRATUIT','PARIS XVII','sport', 1),
(2,'Balade en montagne', 'Je vous propose de faire une randonnée au Pic du Montcalm, niveau intermédiaire, avec pique-nique. Covoiturage possible ! ', '2022-02-28 15:00:00', '8', 'GRATUIT','Marc 09240 ','rencontre', 1),
(3,'Tennis en double', 'Match de tennis en double (niveau débutant) dans la commune de Saint Gilles', '2022-03-02 11:00:00', '4', 'PAYANT','Saint Gilles', 'autre', 1);
